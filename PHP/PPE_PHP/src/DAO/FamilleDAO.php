...
class FamilleDAO extends DAO
{
     ...
     *
     * @return \MicroCMS\Domain\Famille|throws an exception if no matching famille is found
     */
     ...
     *
     * @param \MicroCMS\Domain\Famille $famille The famille to save
     */
     ...
     * @return \MicroCMS\Domain\Famille
     */
