...
class SecteurDAO extends DAO
{
     ...
     *
     * @return \MicroCMS\Domain\Secteur|throws an exception if no matching secteur is found
     */
     ...
     *
     * @param \MicroCMS\Domain\Secteur $secteur The Secteur to save
     */
     ...
     * @return \MicroCMS\Domain\Secteur
     */
